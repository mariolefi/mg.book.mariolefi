  ...
  List list = [
    ...
    () {
      ...
      List<Map<String, dynamic>> output = [
        ...
        {
          "name": "David",
          "courses": ["Computer Scinses", "Progamming"]
        },
        {
          "name": "Eve",
    ...
    () {
      ...
      output = input.toLowerCase() == "true"
          ? true
          : (input.toLowerCase() == "false" ? false : null);
      // --- End of Answer ---
      return output == false;
    },
    // Exercise 103
    () {
      ...
      output = input.toLowerCase() == "true"
          ? true
          : (input.toLowerCase() == "0" ? false : null);
      // --- End of Answer ---
      return output == false;
    },
    // Exercise 104
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      List<double> input = [3.14, 2.17, 1.618];
      List<double>? output;
    ...
    () {
      ...
      Map<String, dynamic>? output;
      output = Map<String, dynamic>.from(input);
      // --- End of Answer ---
    ...
    () {
      ...
      output = List<Map<String, int>>.from(input);
      // --- End of Answer ---
    ...
    () {
      ...
      List<Map<String, dynamic>>? output;
      output = List<Map<String, dynamic>>.from(input);
      // --- End of Answer ---
